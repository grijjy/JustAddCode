...
type
  { As TStackList1, but swaps range check order }
  TStackList2<T: record; TSize: record> = record
  private type
    P = ^T;
  private
    FData: TSize;
...
procedure TStackList2<T, TSize>.Add(const AItem: T);
var
  Target: P;
begin
...
function TStackList2<T, TSize>.GetItem(const AIndex: Integer): T;
var
  Item: P;
begin
...
procedure TStackList2<T, TSize>.Initialize;
begin
