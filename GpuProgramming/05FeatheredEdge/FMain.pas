...
type
  TFormMain = class(TForm3D)
    ...
    LabelBackend: TLabel;
    Plane1: TPlane;
    FloatAnimationRotationY1: TFloatAnimation;
    Plane2: TPlane;
    FloatAnimationRotationY2: TFloatAnimation;
    LabelFeather: TLabel;
    TrackBarFeather: TTrackBar;
    procedure Form3DCreate(Sender: TObject);
    procedure Form3DRender(Sender: TObject; Context: TContext3D);
    procedure TrackBarFeatherChange(Sender: TObject);
  private
    { Private declarations }
    FMaterialSource: TFeatheredEdgeMaterialSource;
...
begin
  LabelBackend.Text := Context.ClassName;

  FMaterialSource := TFeatheredEdgeMaterialSource.Create(Self);
  ...
  Plane1.MaterialSource := FMaterialSource;
  Plane2.MaterialSource := FMaterialSource;
end;
...
procedure TFormMain.TrackBarFeatherChange(Sender: TObject);
begin
  FMaterialSource.Feather := TrackBarFeather.Value;
end;
